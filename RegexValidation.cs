...
namespace UserRegistration
{
    ...
    {   //Regex is a sequence of characters that specifies a search pattern in text
        ...
        //"Match if the string contains an upper case letter, a digit, and a non-alphanumeric, and there are at least 8 characters in total."
        public const string Regex_Password = "^(?=.*[A-Z])(?=.*\\d)(?=[\\w]*[\\W][\\w]*$)[\\S]{8,}$";
        //(?=.*[A-Z]) --->  look-ahead for one uppercase alphabet
